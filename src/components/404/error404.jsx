    ...
    const navigations = [
        {
            ...
            desc: "Venha até a página principal do nosso site.",
        ...
        },
        {
            ...
            desc: "Visite nossa estrutura para ver o profissionalismo.",
            href: "javascript:void(0)"
        }
    ];
            ...
            <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8">
                <div className="max-w-lg mx-auto text-gray-600">
                    <div className="space-y-3 text-center">
                        <p className="text-4xl font-semibold sm:text-5xl" style={{color: '#254a2b'}}>
                            ERRO!
                        </p>
                        <p>
                           Desculpe, ocorreu algum erro! Já foi relatado, em breve será resolvido!
                        </p>
                    </div>
                    <div className="mt-12">
