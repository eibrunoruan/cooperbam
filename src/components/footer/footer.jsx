        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between md:flex-wrap">
                    <div className="mb-6 md:mb-0 md:w-1/2 lg:w-1/3">
                        <a href="https://cooperbam.com.br" className="flex items-center">
                            ...
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">COOPERBAM</span>
                        </a>
                    ...
                    <div className="md:w-1/2 lg:w-2/3">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            <div className="mb-4">
                                ...
                                Massaranduba/SC<br />
                                <a href="mailto:laumar@bananaslaumar.com.br" className="hover:underline">teste@.com.br</a>
                            </div>
                            <div className="mb-4">
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                    <span className="text-sm text-gray-500 mb-4 sm:mb-0 dark:text-gray-400">© 2024 <a href="https://cooperbam.com.br" className="hover:underline">Cooperbam™</a>. Todos os direitos reservados.</span>
