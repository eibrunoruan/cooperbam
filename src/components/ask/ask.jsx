      ...
      <div className="bg-gray-100">
        <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="absolute inset-x-0 top-0 items-center justify-center hidden overflow-hidden md:flex md:inset-y-0">
            ...
            >
            <circle fill="#7a9d4d" fillOpacity="0.02" cx="44" cy="44" r="15.5" />
            <circle fill="#254a2a" fillOpacity="0.02" cx="44" cy="44" r="44" />
            <circle fill="#254a2a" fillOpacity="0.02" cx="44" cy="44" r="37.5" />
            <circle fill="#254a2a" fillOpacity="0.02" cx="44" cy="44" r="29.5" />
            <circle fill="#254a2a" fillOpacity="0.02" cx="44" cy="44" r="22.5" />
            </svg>
          </div>
          <div className="relative grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
              <div className="p-5">
                <div className="flex items-center justify-center w-10 h-10 mb-4 rounded-full" style={{ backgroundColor: '#f0cc44' }}>
                  <svg
                    className="w-8 h-8 text-deep-purple-accent-400"
                    stroke="currentColor"
                    viewBox="0 0 52 52"
