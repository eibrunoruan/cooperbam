    ...
    const testimonials = [
        {
            ...
            quote: "A Cooperbam é uma ótima cooperativa, mas sabe o que falta? Um website feito pela GDRtech :O."
        },
        {
        ...
        <section className="relative py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    <h3 className="text-3xl font-semibold sm:text-4xl" style={{ color: '#254a2b' }}>
                        Ouça nossos clientes
                    </h3>
                    <p className="mt-3 text-gray-600">
                        Nossa cooperativa se dedica a oferecer produtos de alta qualidade e um atendimento excepcional. Valorizamos a transparência, a responsabilidade social e o impacto positivo na comunidade. Descubra por que tantos confiam na Cooperbam!
                    </p>
                </div>
                <div className="mt-12">
